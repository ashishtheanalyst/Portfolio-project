-- Using global COVID Deaths dataset from https://ourworldindata.org/covid-deaths I created two datasets "Coviddeath" dataset and "Covidvaccinations" dataset. We are going to explore and then join these two datasets in the course of data exploration
