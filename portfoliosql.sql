...
--(A) Looking at total cases versus total deaths. We calculate death rate attributed to COVID-19 for all countries and filter death rate for Nepal specifically. 
...
--(B) Looking at total cases versus total population. We calculate COVID-19 infection rate for all countries and filter infection rate for Nepal specifically. 
